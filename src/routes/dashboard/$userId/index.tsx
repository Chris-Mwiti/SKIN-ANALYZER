...
function AnalyticsPage() {
  ...
  const locationData = [
    { name: 'Muranga', value: 200 },
    { name: 'Nairobi', value: 300 },
    { name: 'Mombasa', value: 150 },
    { name: 'Kisumu', value: 70 },
    { name: 'Machakos', value: 200 },
  ]
  ...
  const diagnosisCategoryData = [
    { name: 'Melanoma', value: 70 },
    { name: 'Eczema', value: 40 },
    { name: 'Psoriasis', value: 20 },
    { name: 'Acne', value: 10 },
    { name: 'Rosacea', value: 5 },
  ]
