  ...
  return (
    ...
    <div className='w-screen h-screen min-h-screen text-foreground' >
      <main className='bg-background h-full w-full relative flex-col flex gap-3'>
        <nav className='w-full p-3 md:w-2/3 bg-transparent backdrop-blur-md shadow-lg ring ring-primary absolute z-20  top-2 rounded-xl left-1/2 transform -translate-x-1/2 flex justify-around items-center '>
          <span className="flex space-x-3">
            <Smartphone className="h-6 w-6 text-primary" />
            <span className="ml-2 text-2xl font-bold text-primary">SkynVision AI</span>
          </span>
